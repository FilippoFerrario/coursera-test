...
//show something while waiting content form ajax
...
//Init document modification
document.addEventListener("DOMContentLoaded", function(event) {

//show loading if no content available
...
dc.loadMenuCategories = function () {
  ...
  $ajaxUtils.sendGetRequest(
    allCategoriesUrl,
    buildAndShowCategoriesHTML); //true by default (object converted from json)
};
...
dc.loadMenuItems = function (categoryShort) {
  ...
  $ajaxUtils.sendGetRequest(
    ...
    buildAndShowMenuItemsHTML); //true by default (object converted from json)
};
